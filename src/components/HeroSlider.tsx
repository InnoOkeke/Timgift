        ...
        <div style={{ position: "relative", userSelect: "none", padding: "16px 0 0" }}>
            <div className="container">
                ...
                >
                    ...
                    {/* Arrows */}
                    <button onClick={prev} aria-label="Previous" className="hero-arrow" style={{ position: "absolute", left: "12px", top: "50%", transform: "translateY(-50%)", width: "36px", height: "36px", borderRadius: "50%", backgroundColor: "rgba(0,0,0,0.3)", border: "1px solid rgba(255,255,255,0.2)", color: "white", cursor: "pointer", alignItems: "center", justifyContent: "center", zIndex: 10, backdropFilter: "blur(4px)" }}>
                    ...
                    <button onClick={next} aria-label="Next" className="hero-arrow" style={{ position: "absolute", right: "12px", top: "50%", transform: "translateY(-50%)", width: "36px", height: "36px", borderRadius: "50%", backgroundColor: "rgba(0,0,0,0.3)", border: "1px solid rgba(255,255,255,0.2)", color: "white", cursor: "pointer", alignItems: "center", justifyContent: "center", zIndex: 10, backdropFilter: "blur(4px)" }}>
