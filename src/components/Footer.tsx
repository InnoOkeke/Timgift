...
import { useState, useEffect } from "react"; // Added for scroll visibility
    ...
    return (
        <>
            ...
            {showBackToTop && (
                <button
                    onClick={scrollToTop}
                    className="fixed bottom-6 right-6 z-50 flex items-center justify-center w-12 h-12 rounded-full shadow-lg transition-all hover:scale-110 active:scale-95"
                    style={{
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 sm:gap-y-12 lg:gap-8">
                        ...
                        <div className="flex flex-col items-start text-left">
                            ...
                            <ul className="space-y-4 w-full" style={{ listStyle: "none", padding: 0, margin: 0 }}>
                                ...
                                <li className="flex items-center gap-3 text-sm" style={{ color: "var(--text-secondary)" }}>
                                    <span>📧</span>
                                    <a href="mailto:info@timgift01.com" className="transition-colors hover:text-primary">
                                        info@timgift01.com
                                    </a>
                                </li>
                                <li className="flex items-center gap-3 text-sm" style={{ color: "var(--text-secondary)" }}>
